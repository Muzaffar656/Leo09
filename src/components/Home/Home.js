  ...
  const data = [
    {
      ...
      Description:
        "Team Leo9 works tirelessly to get deliverables to meet all client needs. Their organization should be trusted because they’ve continued todeliver quality over and over again.",
      startImg: starsImg,
    },
    {
      img: clientImage3,
    ...
    <>
      ...
      <section className=" relative sm:top-56 top-40  flex flex-col ">
        <div className="flex gap-4 flex-col sm:container  max-w-4xl px-2 m-auto">
          ...
          {/* Text section */}
          <h1 className="mt-20 sm:mt-28 sm:text-5xl text-4xl leading-tight font-bold">
          ...
          <div className="text-center sm:text-left">
            <div className=" sm:mt-40 mt-24  flex flex-col sm:flex-row items-center justify-between ">
              ...
              <div className="mt-8">
                <img
                  className=" sm:h-96 h-64 w-image-width sm:w-full"
                  src={animation4}
                  alt="animation"
                />
              </div>
            ...
            <div className="flex-col sm:flex-row  mt-6 flex items-center justify-between">
              ...
              <div className="mt-8">
                <img
                  className=" h-96 w-image-width sm:w-full"
                  src={animation2}
                  alt="animation"
                />
              </div>
          ...
          {/* paragraph */}
          <h1 className=" mt-28 sm:text-5xl text-4xl leading-tight font-bold">
          ...
          <section className=" flex flex-col   sm:grid grid-cols-3 gap-5 mt-36 mb-52 px-10  ">
            <div className="red-container  flex flex-col justify-center gap-4  py-36 mt-6 items-center text-center ">
              ...
              <p className=" text-white text-xl">
                Innovated Community Empoverment Website
              </p>
        ...
        <div className=" text-center w-full">
          ...
          <h3 className="mb-11 sm:text-6xl text-4xl  font-bold">
            and counting more..
          </h3>
            ...
            <Slider {...settings}>
              {data.map((el, index) => {
                return (
                  <div
                    key={index}
                    className="bg-client    rounded-md  py-12 h-full "
                  >
                    <div className="flex justify-between m-auto sm:w-4/5 text-center sm:text-left items-center flex-col sm:flex-row ">
                      ...
                      <div className=" w-3/5">
                        ...
                        <img
                          ...
                          className="mt-5 h-8"
                        />
                        <p className="sm:text-2xl font-normal sm:leading-9 leading-7 mt-5 sm:mt-6">
                          {el.Description}
                        </p>
                      </div>
                    </div>
        ...
        <div className="mt-20">
          <div className="container flex flex-col sm:flex-row m-auto max-w-6xl items-center justify-between">
            <div>
              <div className="flex ">
                <button className=" mr-8 h-10" onClick={handleshowBar}>
                  {showBar ? <FaPlus /> : <FaMinus />}
                </button>

                <h1 className="text-3xl font-extrabold">
                  How To Enhance Motivation <br /> for Better Business Leads?
                </h1>
              </div>
              <div className={` ${showBar && "hidden"} ml-16 `}>
                <p className=" text-2xl font-semibold mt-8 mb-8">
                  Read how businessmen must use UX <br /> design and enhancement
                  of motivation <br /> for better business leads. Reveal the{" "}
                  <br /> secret now!
                </p>
                <a
                  href="/"
                  className="mt-12 text-red-500 text-xl flex items-center gap-3"
                >
